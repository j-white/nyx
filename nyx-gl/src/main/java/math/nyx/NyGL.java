 ...
 */
public class NyGL implements GLEventListener, KeyListener {
...
//      gl.glDepthFunc(GL_LEQUAL);  // the type of depth test to do
      ...
      try {
         ...
         texture = TextureIO.newTexture(new ClassPathResource(textureFileName).getURL(),
